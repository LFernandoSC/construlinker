...
const CUENTAS = {
  ...
  var OFERTAS = [
    {
      id: 1,
      titulo: 'Albañil Oficial de Primera — Proyecto Residencial',
      empresa: 'Constructora Inmobiliaria Andina S.A.C.',
      empresaId: 'e1',
      empresaEmoji: '🏢',
      categoria: 'Obra Gruesa',
      zona: 'Miraflores, Lima',
      descripcion: 'Buscamos albañil con experiencia en tarrajeo fino y encofrado metálico para proyecto residencial de 12 pisos. Obra limpia, buen ambiente y pago puntual quincenal.',
      requisitos: ['Mínimo 5 años de experiencia', 'Conocimiento en encofrado metálico', 'Disponibilidad inmediata', 'Con EPPs propios preferente'],
      salario: 'S/. 80 - 100 / día',
      tipo: 'Tiempo completo',
      duracion: '6 meses',
      trabajadoresNeeded: 3,
      fechaInicio: 'Lunes 20 de enero',
      fechaPublicacion: '15 ene 2025',
      urgente: true,
      postulantes: 7,
      activa: true,
      tags: ['Albañil', 'Tarrajeo', 'Encofrado'],
    },
    {
      id: 2,
      titulo: 'Electricista de Obra — Centro Comercial',
      empresa: 'Techcorp Construcciones SAC',
      empresaId: 'e2',
      empresaEmoji: '🏗️',
      categoria: 'Instalaciones',
      zona: 'San Miguel, Lima',
      descripcion: 'Requerimos electricista con experiencia en instalaciones de baja tensión para centro comercial en fase de acabados. Trabajo por destajo con posibilidad de extensión.',
      requisitos: ['Habilitación técnica MEM vigente', 'Experiencia en tableros BT', 'Conocimiento norma EM.010', 'Disponibilidad a partir del lunes'],
      salario: 'S/. 90 - 120 / día',
      tipo: 'Por obra',
      duracion: '3 meses',
      trabajadoresNeeded: 2,
      fechaInicio: 'Inmediato',
      fechaPublicacion: '14 ene 2025',
      urgente: true,
      postulantes: 4,
      activa: true,
      tags: ['Electricista', 'BT', 'Tableros'],
    },
    {
      id: 3,
      titulo: 'Pintor de Acabados — Edificio de Oficinas',
      empresa: 'Multiprojects SA',
      empresaId: 'e3',
      empresaEmoji: '🏢',
      categoria: 'Acabados',
      zona: 'Surquillo, Lima',
      descripcion: 'Se necesita pintor con experiencia en pintura látex y esmalte para edificio corporativo. Acabados de alta calidad, 8 pisos, trabajo por piso terminado.',
      requisitos: ['Experiencia en pintura de interiores', 'Manejo de rodillo y pistola', 'Ordenado y puntual'],
      salario: 'S/. 70 - 85 / día',
      tipo: 'Por obra',
      duracion: '2 meses',
      trabajadoresNeeded: 4,
      fechaInicio: 'Esta semana',
      fechaPublicacion: '13 ene 2025',
      urgente: false,
      postulantes: 11,
      activa: true,
      tags: ['Pintor', 'Látex', 'Esmalte'],
    },
    {
      id: 4,
      titulo: 'Jefe de Obra — Proyecto Vivienda Social',
      empresa: 'Besco SAC',
      empresaId: 'e4',
      empresaEmoji: '🏗️',
      categoria: 'Técnicos y Gestión',
      zona: 'Villa El Salvador, Lima',
      descripcion: 'Buscamos Jefe de Obra con experiencia en proyectos de vivienda social (VIS/VIP). Manejo de S10, MS Project y equipos de hasta 50 personas. Contrato en planilla.',
      requisitos: ['Ingeniero Civil o Arquitecto colegiado', 'Mínimo 8 años de experiencia', 'Experiencia en proyectos VIS', 'Manejo S10 y MS Project'],
      salario: 'S/. 6,000 - 8,000 / mes',
      tipo: 'Planilla',
      duracion: '18 meses',
      trabajadoresNeeded: 1,
      fechaInicio: '01 febrero 2025',
      fechaPublicacion: '12 ene 2025',
      urgente: false,
      postulantes: 3,
      activa: true,
      tags: ['Jefe de Obra', 'VIS', 'Gestión'],
    },
    {
      id: 5,
      titulo: 'Operador de Retroexcavadora — Obra Vial',
      empresa: 'MTC Infraestructura',
      empresaId: 'e5',
      empresaEmoji: '🚜',
      categoria: 'Maquinaria y Transporte',
      zona: 'Lurín, Lima',
      descripcion: 'Se requiere operador de retroexcavadora con licencia MTC vigente para obra de ampliación vial en Lurín. Trabajo de lunes a sábado, alimentación incluida.',
      requisitos: ['Licencia MTC Cat. A IIIc vigente', 'Experiencia mínima 5 años', 'Con record de conductor', 'Disponible de lunes a sábado'],
      salario: 'S/. 100 - 130 / día',
      tipo: 'Tiempo completo',
      duracion: '4 meses',
      trabajadoresNeeded: 2,
      fechaInicio: 'Inmediato',
      fechaPublicacion: '11 ene 2025',
      urgente: true,
      postulantes: 5,
      activa: true,
      tags: ['Retroexcavadora', 'Operador', 'Vial'],
    },
    {
      id: 6,
      titulo: 'Técnico PRL — Obra Multifamiliar',
      empresa: 'Inmobiliaria Sur SAC',
      empresaId: 'e6',
      empresaEmoji: '🏢',
      categoria: 'Técnicos y Gestión',
      zona: 'Barranco, Lima',
      descripcion: 'Requerimos técnico en PRL para supervisión de seguridad en proyecto multifamiliar de 16 pisos. Elaboración de IPERC, PETS y simulacros. Reporta al jefe de obra.',
      requisitos: ['Certificación PRL nivel avanzado', 'Conocimiento G.050', 'Experiencia en edificaciones', 'Registro SUNAFIL al día'],
      salario: 'S/. 3,500 - 4,500 / mes',
      tipo: 'Planilla',
      duracion: '12 meses',
      trabajadoresNeeded: 1,
      fechaInicio: '15 enero 2025',
      fechaPublicacion: '10 ene 2025',
      urgente: false,
      postulantes: 2,
      activa: true,
      tags: ['PRL', 'SSOMA', 'Seguridad'],
    },
  ];
  
  // ── GESTIÓN DE OFERTAS ────────────────────────────────────────
  function publicarOferta(datos) {
    var nueva = {
      id: Date.now(),
      titulo:             datos.titulo,
      empresa:            ESTADO.nombreUsuario || 'Mi Empresa',
      empresaId:          ESTADO.userId || 'e1',
      empresaEmoji:       '🏢',
      categoria:          datos.categoria,
      zona:               datos.zona,
      descripcion:        datos.descripcion,
      requisitos:         datos.requisitos || [],
      salario:            datos.salario || 'A convenir',
      tipo:               datos.tipo || 'Por obra',
      duracion:           datos.duracion || 'A definir',
      trabajadoresNeeded: parseInt(datos.cantidad) || 1,
      fechaInicio:        datos.fechaInicio || 'Inmediato',
      fechaPublicacion:   new Date().toLocaleDateString('es-PE', { day:'2-digit', month:'short', year:'numeric' }),
  ...
  function postularOferta(ofertaId) {
    ...
    if (ESTADO.postulaciones.includes(ofertaId)) return false;
    ESTADO.postulaciones.push(ofertaId);
    var o = OFERTAS.find(function(x) { return x.id === ofertaId; });
    if (o) o.postulantes++;
    guardarEstado();
    return true;
  }
  ...
  function yaPostulado(ofertaId) {
    return ESTADO.postulaciones && ESTADO.postulaciones.includes(ofertaId);
  }
